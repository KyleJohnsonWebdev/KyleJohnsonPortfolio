  ...
  return (
    <div>
      <Helmet>
        ...
        <meta name="description" content="Kyle Johnson Web Development Portfolio Freelance">
        I am here to figure out what your needs are. I am here for you. Let me help you make something great. I will not try to upsell you. I will always explain processes. Your company has needs. Let me work with you.
        The first step in the process. I start with the old school method of pencil and paper.'The first set of wire frames are hand drawn. I sometimes will convert these hand drawn wire frames into a prototyping software called XD. The first stage is in greyscale. Little details are not included in this step.
        I use adobe XD before I code anything. It is a good idea to figure out what you want before coding a project.This is where detail comes into play. We can figure out if the look feels right. Are buttons making sense? The prototype gives you a partially functional program. It is at this stage that user testing would occur.
